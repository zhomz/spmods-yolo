...
// New quests
import * as questJson from "../db/quests.json";
...
// more helpers
import { ItemCreateHelper } from "./helpers/itemCreateHelper";
import { PresetCreateHelper } from "./helpers/presetCreateHelper";
import * as path from "path";
const fs = require('fs');
const modPath = path.normalize(path.join(__dirname, '..'));

class Vicktoriya implements IPreAkiLoadMod, IPostDBLoadMod, IPostAkiLoadMod
{
    private mod: string
    ...
    public postDBLoad(container: DependencyContainer): void
    {
        ...
        const presetCreate = new PresetCreateHelper();
        ...
        for (const quest in questJson)
        {
            if (quest != "default")
            {
                const questToAdd: IQuest = questJson[quest];
        ...
        else if (isGamblingContainer)
        {
            ...
            if (whichGamblingContainer._name.includes("wallet")) 
            {
                ...
                while (stackCount > loops) 
                {
                    ...
                    if (roll >= this.vikConfig.wr_one)
                    {
                        ...
                        {
                            money += 100000;
                            if (this.vikConfig.Logging){console.log("[" + this.mod + "] 100k win");}
                        } 
                        else if (roll <= this.vikConfig.wr_three) 
                        {
                            money += 300000;
                            if (this.vikConfig.Logging){console.log("[" + this.mod + "] 300k win");}
                        } 
                        else if (roll <= this.vikConfig.wr_four) 
                        {
                            money += 500000;
                            if (this.vikConfig.Logging){console.log("[" + this.mod + "] 500k win");}
                        }
                        else
                        {
                            money += 2000000;
                            if (this.vikConfig.Logging){console.log("[" + this.mod + "] 2m win");}
                        }
                    }                    
                    loops++;
                    if (this.vikConfig.Logging){console.log(money)};
                }
                if (this.vikConfig.Logging){console.log("[" + this.mod + "] You opened " + loops + " wallets and earned " + money + ". Spending a total of: " + stackCount * 100000);}
                if (money > 0)
                {
            ...
            else if (whichGamblingContainer._name.includes("50/50"))
            {
                ...
                if (roll <= 500)
                {
					...
					if (this.vikConfig.Logging){console.log("[" + this.mod + "] 50/50 loose, Can of beef stew (Small) added (you roll " + roll + " of " + this.vikConfig.kcr_eight + ")");}
                    foundInRaid = true;
                }
                else
                {
					...
					if (this.vikConfig.Logging){console.log("[" + this.mod + "] 50/50 win!, 10m added (you roll " + roll + " of " + this.vikConfig.kcr_eight + ")");}
                    foundInRaid = true;
                }
            }
            ...
            else if (whichGamblingContainer._name.includes("keycard"))
            {
                ...
                if (roll <= this.vikConfig.kcr_one)
                {
					...
					if (this.vikConfig.Logging){console.log("[" + this.mod + "] TerraGroup Labs access keycard win (you roll " + roll + " of " + this.vikConfig.kcr_eight + ")");}
                }
                else if (roll <= this.vikConfig.kcr_two)
                {
                    id = "5efde6b4f5448336730dbd61"; // Keycard with a blue marking
					if (this.vikConfig.Logging){console.log("[" + this.mod + "] Keycard with a blue marking win (you roll " + roll + " of " + this.vikConfig.kcr_eight + ")");}
                }
                else if (roll <= this.vikConfig.kcr_three)
                {
                    id = "5c1d0d6d86f7744bb2683e1f"; // TerraGroup Labs keycard (Yellow)
					if (this.vikConfig.Logging){console.log("[" + this.mod + "] TerraGroup Labs keycard (Yellow) win (you roll " + roll + " of " + this.vikConfig.kcr_eight + ")");}
                }
                else if (roll <= this.vikConfig.kcr_four)
                {
                    id = "5c1d0f4986f7744bb01837fa"; // TerraGroup Labs keycard (Black)
					if (this.vikConfig.Logging){console.log("[" + this.mod + "] TerraGroup Labs keycard (Black) win (you roll " + roll + " of " + this.vikConfig.kcr_eight + ")");}
                }
                else if (roll <= this.vikConfig.kcr_five)
                {
                    id = "5c1e495a86f7743109743dfb"; // TerraGroup Labs keycard (Violet)
					if (this.vikConfig.Logging){console.log("[" + this.mod + "] TerraGroup Labs keycard (Violet) win (you roll " + roll + " of " + this.vikConfig.kcr_eight + ")");}
                }
                else if (roll <= this.vikConfig.kcr_six)
                {
                    id = "5c1d0c5f86f7744bb2683cf0"; // TerraGroup Labs keycard (Blue)
					if (this.vikConfig.Logging){console.log("[" + this.mod + "] TerraGroup Labs keycard (Blue) win (you roll " + roll + " of " + this.vikConfig.kcr_eight + ")");}
                }
                else if (roll <= this.vikConfig.kcr_seven)
                {
                    id = "5c1d0dc586f7744baf2e7b79"; // TerraGroup Labs keycard (Green)
					if (this.vikConfig.Logging){console.log("[" + this.mod + "] TerraGroup Labs keycard (Green) win (you roll " + roll + " of " + this.vikConfig.kcr_eight + ")");}
                }
                else
                {
                    id = "5c1d0efb86f7744baf2e7b7b"; // TerraGroup Labs keycard (Red)
					if (this.vikConfig.Logging){console.log("[" + this.mod + "] TerraGroup Labs keycard (Red) win (you roll " + roll + " of " + this.vikConfig.kcr_eight + ")");}
                }
                ...
                if (roll <= this.vikConfig.kcr_ornament_chance)
                {
					...
					if (this.vikConfig.Logging){console.log("[" + this.mod + "] Viktoriyas Voucher win (you roll " + roll + " of 100)");}
                } else {
					if (this.vikConfig.Logging){console.log("[" + this.mod + "] Viktoriyas Voucher loose (you roll " + roll + " of 100)");}
				}
                newItemRequest.items.push(this.addToNewItemArray(id, false, 1));
            ...
            else if (whichGamblingContainer._name.includes("kc_prm"))
            {
                ...
                {
                    id = "5c94bbff86f7747ee735c08f"; // TerraGroup Labs access keycard
					if (this.vikConfig.Logging){console.log("[" + this.mod + "] TerraGroup Labs access keycard win (you roll " + roll + " of " + this.vikConfig.kcpr_seven + ")");}
                } 
                else if (roll <= this.vikConfig.kcpr_two)
                {
                    id = "5c1d0d6d86f7744bb2683e1f"; // TerraGroup Labs keycard (Yellow)
					if (this.vikConfig.Logging){console.log("[" + this.mod + "] TerraGroup Labs keycard (Yellow) win (you roll " + roll + " of " + this.vikConfig.kcpr_seven + ")");}
                }
                else if (roll <= this.vikConfig.kcpr_three)
                {
                    id = "5c1d0f4986f7744bb01837fa"; // TerraGroup Labs keycard (Black)
					if (this.vikConfig.Logging){console.log("[" + this.mod + "] TerraGroup Labs keycard (Black) win (you roll " + roll + " of " + this.vikConfig.kcpr_seven + ")");}
                }
                else if (roll <= this.vikConfig.kcpr_four)
                {
                    id = "5c1e495a86f7743109743dfb"; // TerraGroup Labs keycard (Violet)
					if (this.vikConfig.Logging){console.log("[" + this.mod + "] TerraGroup Labs keycard (Violet) win (you roll " + roll + " of " + this.vikConfig.kcpr_seven + ")");}
                }
                else if (roll <= this.vikConfig.kcpr_five)
                {
                    id = "5c1d0c5f86f7744bb2683cf0"; // TerraGroup Labs keycard (Blue)
					if (this.vikConfig.Logging){console.log("[" + this.mod + "] TerraGroup Labs keycard (Blue) win (you roll " + roll + " of " + this.vikConfig.kcpr_seven + ")");}
                }
                else if (roll <= this.vikConfig.kcpr_six)
                {
                    id = "5c1d0dc586f7744baf2e7b79"; // TerraGroup Labs keycard (Green)
					if (this.vikConfig.Logging){console.log("[" + this.mod + "] TerraGroup Labs keycard (Green) win (you roll " + roll + " of " + this.vikConfig.kcpr_seven + ")");}
                }
                else
                {
                    id = "5c1d0efb86f7744baf2e7b7b"; // TerraGroup Labs keycard (Red)
					if (this.vikConfig.Logging){console.log("[" + this.mod + "] TerraGroup Labs keycard (Red) win (you roll " + roll + " of " + this.vikConfig.kcpr_seven + ")");}
                }
            ...
            else if (whichGamblingContainer._name.includes("viktoriyas"))
            {
                ...
                if (roll <= this.vikConfig.vsc_one)
                {
					...
					if (this.vikConfig.Logging){console.log("[" + this.mod + "] Exfil B For Viktoriya's Secret Preset win (you roll " + roll + " of " + this.vikConfig.vsc_thirteen + ")");}
                }
                else if (roll <= this.vikConfig.vsc_two)
                {
                    ...
                    isPreset = false;
                    newItemRequest.items.push(this.addToNewItemArray(id, isPreset, count));
					if (this.vikConfig.Logging){console.log("[" + this.mod + "] LBT-6094A Slick Plate Carrier win (you roll " + roll + " of " + this.vikConfig.vsc_thirteen + ")");}
                } 
                else if (roll <= this.vikConfig.vsc_three)
                {
                    ...
                    isPreset = true;
                    newItemRequest.items.push(this.addToNewItemArray(id, isPreset, count));
					if (this.vikConfig.Logging){console.log("[" + this.mod + "] Exfil Coyote For Viktoriya's Secret Preset win (you roll " + roll + " of " + this.vikConfig.vsc_thirteen + ")");}
                }
                else if (roll <= this.vikConfig.vsc_four)
                {
                    ...
                    count = 10;
                    newItemRequest.items.push(this.addToNewItemArray(id, isPreset, count));
					if (this.vikConfig.Logging){console.log("[" + this.mod + "] RD704 For Viktoriya's Secret Preset win (you roll " + roll + " of " + this.vikConfig.vsc_thirteen + ")");}
                }
                else if (roll <= this.vikConfig.vsc_five)
                {
                    ...
                    isPreset = false;
                    newItemRequest.items.push(this.addToNewItemArray(id, isPreset, count));
					if (this.vikConfig.Logging){console.log("[" + this.mod + "] IOTV Gen4 body armor (Assault Kit) win (you roll " + roll + " of " + this.vikConfig.vsc_thirteen + ")");}
                }
                else if (roll <= this.vikConfig.vsc_six)
                {
                    ...
                    isPreset = false;
                    newItemRequest.items.push(this.addToNewItemArray(id, isPreset, count));
					if (this.vikConfig.Logging){console.log("[" + this.mod + "] IOTV Gen4 body armor (Full Protection Kit) win (you roll " + roll + " of " + this.vikConfig.vsc_thirteen + ")");}
                }
                else if (roll <= this.vikConfig.vsc_seven)
                {
                    ...
                    isPreset = false;
                    newItemRequest.items.push(this.addToNewItemArray(id, isPreset, count));
					if (this.vikConfig.Logging){console.log("[" + this.mod + "] IOTV Gen4 body armor (High Mobility Kit) win (you roll " + roll + " of " + this.vikConfig.vsc_thirteen + ")");}
                }
                else if (roll <= this.vikConfig.vsc_eight)
                {
                    ...
                    isPreset = false;
                    newItemRequest.items.push(this.addToNewItemArray(id, isPreset, count));
					if (this.vikConfig.Logging){console.log("[" + this.mod + "] 5.11 Tactical Hexgrid plate carrier win (you roll " + roll + " of " + this.vikConfig.vsc_thirteen + ")");}
                }
                else if (roll <= this.vikConfig.vsc_nine)
                {
                    ...
                    count = 1;
                    newItemRequest.items.push(this.addToNewItemArray(id, isPreset, count));
					if (this.vikConfig.Logging){console.log("[" + this.mod + "] Ak74N For Viktoriya's Secret Preset win (you roll " + roll + " of " + this.vikConfig.vsc_thirteen + ")");}
                }
                else if (roll <= this.vikConfig.vsc_ten)
                {
                    ...
                    count = 6;
                    newItemRequest.items.push(this.addToNewItemArray(id, isPreset, count));
					if (this.vikConfig.Logging){console.log("[" + this.mod + "] VSS For Viktoriya's Secret Preset win (you roll " + roll + " of " + this.vikConfig.vsc_thirteen + ")");}
                }
                else if (roll <= this.vikConfig.vsc_eleven)
                {
                    ...
                    count = 2;
                    newItemRequest.items.push(this.addToNewItemArray(id, isPreset, count));
					if (this.vikConfig.Logging){console.log("[" + this.mod + "] T5000 For Viktoriya's Secret Preset win (you roll " + roll + " of " + this.vikConfig.vsc_thirteen + ")");}
                ...
                else if (roll <= this.vikConfig.vsc_twelve)
                {
                    ...
                    isPreset = false;
                    newItemRequest.items.push(this.addToNewItemArray(id, isPreset, count));
					if (this.vikConfig.Logging){console.log("[" + this.mod + "] Rsh12 For Viktoriya's Secret Preset win (you roll " + roll + " of " + this.vikConfig.vsc_thirteen + ")");}
                }
                else
                {
                    ...
                    isPreset = true;
                    newItemRequest.items.push(this.addToNewItemArray(id, isPreset, count));
					if (this.vikConfig.Logging){console.log("[" + this.mod + "] Altyn For Viktoriya's Secret Preset win (you roll " + roll + " of " + this.vikConfig.vsc_thirteen + ")");}
                }
            ...
            else if (whichGamblingContainer._name.includes("armor"))
            {
                ...
                if (roll <= this.vikConfig.bac_one)
                {
					...
					if (this.vikConfig.Logging){console.log("[" + this.mod + "] BNTI Module-3M body armor win (you roll " + roll + " of " + this.vikConfig.bac_twenty + ")");}
                }
                else if (roll <= this.vikConfig.bac_two) 
                {
					id = "5648a7494bdc2d9d488b4583"; // PACA Soft Armor
					if (this.vikConfig.Logging){console.log("[" + this.mod + "] PACA Soft Armor win (you roll " + roll + " of " + this.vikConfig.bac_twenty + ")");}
                }
                else if (roll <= this.vikConfig.bac_three) 
                {
					id = "5df8a2ca86f7740bfe6df777"; // 6B2 body armor (Flora)
					if (this.vikConfig.Logging){console.log("[" + this.mod + "] 6B2 body armor (Flora) win (you roll " + roll + " of " + this.vikConfig.bac_twenty + ")");}
                }
                else if (roll <= this.vikConfig.bac_four)
                {
					id = "5ab8e4ed86f7742d8e50c7fa"; // MF-UNTAR body armor
					if (this.vikConfig.Logging){console.log("[" + this.mod + "] MF-UNTAR body armor win (you roll " + roll + " of " + this.vikConfig.bac_twenty + ")");}
                }
                else if (roll <= this.vikConfig.bac_five) 
                {
                    id = "5c0e5edb86f77461f55ed1f7"; // BNTI Zhuk-3 body armor (Press)
					if (this.vikConfig.Logging){console.log("[" + this.mod + "] BNTI Zhuk-3 body armor (Press) win (you roll " + roll + " of " + this.vikConfig.bac_twenty + ")");}
                }
                else if (roll <= this.vikConfig.bac_six)
                {
					id = "5c0e5bab86f77461f55ed1f3"; // 6B23-1 body armor (Digital Flora)
					if (this.vikConfig.Logging){console.log("[" + this.mod + "] 6B23-1 body armor (Digital Flora) win (you roll " + roll + " of " + this.vikConfig.bac_twenty + ")");}
                }
                else if (roll <= this.vikConfig.bac_seven)
                {
                    id = "5b44d22286f774172b0c9de8"; // BNTI Kirasa-N body armor
					if (this.vikConfig.Logging){console.log("[" + this.mod + "] BNTI Kirasa-N body armor win (you roll " + roll + " of " + this.vikConfig.bac_twenty + ")");}
                }
                else if (roll <= this.vikConfig.bac_eight)
                {
					id = "5c0e655586f774045612eeb2"; // HighCom Trooper TFO body armor (Multicam)
					if (this.vikConfig.Logging){console.log("[" + this.mod + "] HighCom Trooper TFO body armor (Multicam) win (you roll " + roll + " of " + this.vikConfig.bac_twenty + ")");}
                }
                else if (roll <= this.vikConfig.bac_nine)
                {
					id = "609e8540d5c319764c2bc2e9"; // NFM THOR Concealable Reinforced Vest body armor
					if (this.vikConfig.Logging){console.log("[" + this.mod + "] NFM THOR Concealable Reinforced Vest body armor win (you roll " + roll + " of " + this.vikConfig.bac_twenty + ")");}
                }
                else if (roll <= this.vikConfig.bac_ten)
                {
					id = "5c0e53c886f7747fa54205c7"; // 6B13 assault armor (Digital Flora)
					if (this.vikConfig.Logging){console.log("[" + this.mod + "] 6B13 assault armor (Digital Flora) win (you roll " + roll + " of " + this.vikConfig.bac_twenty + ")");}
                }
                else if (roll <= this.vikConfig.bac_eleven)
                {
					id = "5c0e57ba86f7747fa141986d"; // 6B23-2 body armor (Mountain Flora)
					if (this.vikConfig.Logging){console.log("[" + this.mod + "] 6B23-2 body armor (Mountain Flora) win (you roll " + roll + " of " + this.vikConfig.bac_twenty + ")");}
                }
                else if (roll <= this.vikConfig.bac_twelve)
                {
                    id = "63737f448b28897f2802b874"; // Hexatac HPC Plate Carrier (Multicam Black)
					if (this.vikConfig.Logging){console.log("[" + this.mod + "] Hexatac HPC Plate Carrier (Multicam Black) win (you roll " + roll + " of " + this.vikConfig.bac_twenty + ")");}
                }
                else if (roll <= this.vikConfig.bac_thirteen)
                {
                    id = "5f5f41476bdad616ad46d631"; // NPP KlASS Korund-VM body armor
					if (this.vikConfig.Logging){console.log("[" + this.mod + "] NPP KlASS Korund-VM body armor win (you roll " + roll + " of " + this.vikConfig.bac_twenty + ")");}
                }
                else if (roll <= this.vikConfig.bac_fourteen)
                {
					id = "5ca2151486f774244a3b8d30"; // FORT Redut-M body armor
					if (this.vikConfig.Logging){console.log("[" + this.mod + "] FORT Redut-M body armor win (you roll " + roll + " of " + this.vikConfig.bac_twenty + ")");}
                }
                else if (roll <= this.vikConfig.bac_fifteen)
                {
					id = "5b44d0de86f774503d30cba8"; // IOTV Gen4 body armor (High Mobility Kit)
					if (this.vikConfig.Logging){console.log("[" + this.mod + "] IOTV Gen4 body armor (High Mobility Kit) win (you roll " + roll + " of " + this.vikConfig.bac_twenty + ")");}
                }
                else if (roll <= this.vikConfig.bac_sixteen)
                {
					id = "5e9dacf986f774054d6b89f4"; // FORT Defender-2 body armor
					if (this.vikConfig.Logging){console.log("[" + this.mod + "] FORT Defender-2 body armor win (you roll " + roll + " of " + this.vikConfig.bac_twenty + ")");}
                }
                else if (roll <= this.vikConfig.bac_seventeen)
                {
					id = "5b44cf1486f77431723e3d05"; // IOTV Gen4 body armor (Assault Kit)
					if (this.vikConfig.Logging){console.log("[" + this.mod + "] IOTV Gen4 body armor (Assault Kit) win (you roll " + roll + " of " + this.vikConfig.bac_twenty + ")");}
                }
                else if (roll <= this.vikConfig.bac_eighteen)
                {
					id = "5b44cd8b86f774503d30cba2"; // IOTV Gen4 body armor (Full Protection Kit)
					if (this.vikConfig.Logging){console.log("[" + this.mod + "] IOTV Gen4 body armor (Full Protection Kit) win (you roll " + roll + " of " + this.vikConfig.bac_twenty + ")");}
                }
                else if (roll <= this.vikConfig.bac_nineteen)
                {
					id = "5ca21c6986f77479963115a7"; // FORT Redut-T5 body armor
					if (this.vikConfig.Logging){console.log("[" + this.mod + "] FORT Redut-T5 body armor win (you roll " + roll + " of " + this.vikConfig.bac_twenty + ")");}
                }
                else
                {
					id = "5ab8e79e86f7742d8b372e78"; // BNTI Gzhel-K body armor
					if (this.vikConfig.Logging){console.log("[" + this.mod + "] BNTI Gzhel-K body armor win (you roll " + roll + " of " + this.vikConfig.bac_twenty + ")");}
                }
                newItemRequest.items.push(this.addToNewItemArray(id, false, 1));
            ...
            else if (whichGamblingContainer._name.includes("premium"))
            {
                ...
                {
					id = "5c0e655586f774045612eeb2"; // HighCom Trooper TFO body armor (Multicam)
					if (this.vikConfig.Logging){console.log("[" + this.mod + "] HighCom Trooper TFO body armor (Multicam) win (you roll " + roll + " of " + this.vikConfig.pac_twenty + ")");}
                } 
                else if (roll <= this.vikConfig.pac_two) 
                {
					id = "609e8540d5c319764c2bc2e9"; // NFM THOR Concealable Reinforced Vest body armor
					if (this.vikConfig.Logging){console.log("[" + this.mod + "] NFM THOR Concealable Reinforced Vest body armor win (you roll " + roll + " of " + this.vikConfig.pac_twenty + ")");}
                }
                else if (roll <= this.vikConfig.pac_three) 
                {
					id = "5c0e53c886f7747fa54205c7"; // 6B13 assault armor (Digital Flora)
					if (this.vikConfig.Logging){console.log("[" + this.mod + "] 6B13 assault armor (Digital Flora) win (you roll " + roll + " of " + this.vikConfig.pac_twenty + ")");}
                }
                else if (roll <= this.vikConfig.pac_four) 
                {
					id = "5c0e57ba86f7747fa141986d"; // 6B23-2 body armor (Mountain Flora)
					if (this.vikConfig.Logging){console.log("[" + this.mod + "] 6B23-2 body armor (Mountain Flora) win (you roll " + roll + " of " + this.vikConfig.pac_twenty + ")");}
                }
                else if (roll <= this.vikConfig.pac_five) 
                {
                    id = "63737f448b28897f2802b874"; // Hexatac HPC Plate Carrier (Multicam Black)
					if (this.vikConfig.Logging){console.log("[" + this.mod + "] Hexatac HPC Plate Carrier (Multicam Black) win (you roll " + roll + " of " + this.vikConfig.pac_twenty + ")");}
                }
                else if (roll <= this.vikConfig.pac_six) 
                {
                    id = "5f5f41476bdad616ad46d631"; // NPP KlASS Korund-VM body armor
					if (this.vikConfig.Logging){console.log("[" + this.mod + "] NPP KlASS Korund-VM body armor win (you roll " + roll + " of " + this.vikConfig.pac_twenty + ")");}
                }
                else if (roll <= this.vikConfig.pac_seven) 
                {
					id = "5ca2151486f774244a3b8d30"; // FORT Redut-M body armor
					if (this.vikConfig.Logging){console.log("[" + this.mod + "] FORT Redut-M body armor win (you roll " + roll + " of " + this.vikConfig.pac_twenty + ")");}
                }
                else if (roll <= this.vikConfig.pac_eight) 
                {
					id = "5b44d0de86f774503d30cba8"; // IOTV Gen4 body armor (High Mobility Kit)
					if (this.vikConfig.Logging){console.log("[" + this.mod + "] IOTV Gen4 body armor (High Mobility Kit) win (you roll " + roll + " of " + this.vikConfig.pac_twenty + ")");}
                }
                else if (roll <= this.vikConfig.pac_nine) 
                {
					id = "5e9dacf986f774054d6b89f4"; // FORT Defender-2 body armor
					if (this.vikConfig.Logging){console.log("[" + this.mod + "] FORT Defender-2 body armor win (you roll " + roll + " of " + this.vikConfig.pac_twenty + ")");}
                }
                else if (roll <= this.vikConfig.pac_ten) 
                {
					id = "5b44cf1486f77431723e3d05"; // IOTV Gen4 body armor (Assault Kit)
					if (this.vikConfig.Logging){console.log("[" + this.mod + "] IOTV Gen4 body armor (Assault Kit) win (you roll " + roll + " of " + this.vikConfig.pac_twenty + ")");}
                }
                else if (roll <= this.vikConfig.pac_eleven) 
                {
					id = "5b44cd8b86f774503d30cba2"; // IOTV Gen4 body armor (Full Protection Kit)
					if (this.vikConfig.Logging){console.log("[" + this.mod + "] IOTV Gen4 body armor (Full Protection Kit) win (you roll " + roll + " of " + this.vikConfig.pac_twenty + ")");}
                }
                else if (roll <= this.vikConfig.pac_twelve) 
                {
					id = "5ca21c6986f77479963115a7"; // FORT Redut-T5 body armor
					if (this.vikConfig.Logging){console.log("[" + this.mod + "] FORT Redut-T5 body armor win (you roll " + roll + " of " + this.vikConfig.pac_twenty + ")");}
                }
                else if (roll <= this.vikConfig.pac_thirteen) 
                {
					id = "5ab8e79e86f7742d8b372e78"; // BNTI Gzhel-K body armor
					if (this.vikConfig.Logging){console.log("[" + this.mod + "] BNTI Gzhel-K body armor win (you roll " + roll + " of " + this.vikConfig.pac_twenty + ")");}
                }
                else if (roll <= this.vikConfig.pac_fourteen) 
                {
                    id = "5fd4c474dd870108a754b241"; // 5.11 Tactical Hexgrid plate carrier
					if (this.vikConfig.Logging){console.log("[" + this.mod + "] 5.11 Tactical Hexgrid plate carrier win (you roll " + roll + " of " + this.vikConfig.pac_twenty + ")");}
                }
                else if (roll <= this.vikConfig.pac_fifteen) 
                {
                    id = "5c0e625a86f7742d77340f62"; // BNTI Zhuk-6a body armor
					if (this.vikConfig.Logging){console.log("[" + this.mod + "] BNTI Zhuk-6a body armor win (you roll " + roll + " of " + this.vikConfig.pac_twenty + ")");}
                }
                else if (roll <= this.vikConfig.pac_sixteen) 
                {
					id = "60a283193cb70855c43a381d"; // NFM THOR Integrated Carrier body armor
					if (this.vikConfig.Logging){console.log("[" + this.mod + "] NFM THOR Integrated Carrier body armor win (you roll " + roll + " of " + this.vikConfig.pac_twenty + ")");}
                }
                else if (roll <= this.vikConfig.pac_seventeen) 
                {
                    id = "545cdb794bdc2d3a198b456a"; // 6B43 6A Zabralo-Sh body armor
					if (this.vikConfig.Logging){console.log("[" + this.mod + "] 6B43 6A Zabralo-Sh body armor win (you roll " + roll + " of " + this.vikConfig.pac_twenty + ")");}
                }
                else if (roll <= this.vikConfig.pac_eighteen) 
                {
                    id = "6038b4ca92ec1c3103795a0d"; // LBT-6094A Slick Plate Carrier (Olive Drab)
					if (this.vikConfig.Logging){console.log("[" + this.mod + "] LBT-6094A Slick Plate Carrier (Olive Drab) win (you roll " + roll + " of " + this.vikConfig.pac_twenty + ")");}
                }
                else if (roll <= this.vikConfig.pac_nineteen) 
                {
                    id = "6038b4b292ec1c3103795a0b"; // LBT-6094A Slick Plate Carrier (Tan)
					if (this.vikConfig.Logging){console.log("[" + this.mod + "] LBT-6094A Slick Plate Carrier (Tan) win (you roll " + roll + " of " + this.vikConfig.pac_twenty + ")");}
                }
                else
                {
                    id = "5e4abb5086f77406975c9342"; // LBT-6094A Slick Plate Carrier
					if (this.vikConfig.Logging){console.log("[" + this.mod + "] LBT-6094A Slick Plate Carrier win (you roll " + roll + " of " + this.vikConfig.pac_twenty + ")");}
                }
            ...
            else if (whichGamblingContainer._name.includes("762"))
            {
                ...
                if (roll <= this.vikConfig.sstc_one) 
                {
                    ...
                    count = 3;
                    newItemRequest.items.push(this.addToNewItemArray(id, isPreset, count));
					if (this.vikConfig.Logging){console.log("[" + this.mod + "] RD704 For Viktoriya's Secret Preset win (you roll " + roll + " of " + this.vikConfig.sstc_twelve + ")");}
                }
                else if (roll <= this.vikConfig.sstc_two)
                {
                    ...
                    count = 3;
                    newItemRequest.items.push(this.addToNewItemArray(id, isPreset, count));
					if (this.vikConfig.Logging){console.log("[" + this.mod + "] VPO Vik For 762 case Preset win (you roll " + roll + " of " + this.vikConfig.sstc_twelve + ")");}
                }
                else if (roll <= this.vikConfig.sstc_three)
                {
                    ...
                    count = 3;
                    newItemRequest.items.push(this.addToNewItemArray(id, isPreset, count));
					if (this.vikConfig.Logging){console.log("[" + this.mod + "] AK-103 default Preset win (you roll " + roll + " of " + this.vikConfig.sstc_twelve + ")");}
                }
                else if (roll <= this.vikConfig.sstc_four)
                {
                    ...
                    count = 3;
                    newItemRequest.items.push(this.addToNewItemArray(id, isPreset, count));
					if (this.vikConfig.Logging){console.log("[" + this.mod + "] RD704 Default win (you roll " + roll + " of " + this.vikConfig.sstc_twelve + ")");}
                }
                else if (roll <= this.vikConfig.sstc_five)
                {
                    ...
                    count = 3;
                    newItemRequest.items.push(this.addToNewItemArray(id, isPreset, count));
					if (this.vikConfig.Logging){console.log("[" + this.mod + "] Mk47 default win (you roll " + roll + " of " + this.vikConfig.sstc_twelve + ")");}
                }
                else if (roll <= this.vikConfig.sstc_six)
                {
                    ...
                    count = 3;
                    newItemRequest.items.push(this.addToNewItemArray(id, isPreset, count));
					if (this.vikConfig.Logging){console.log("[" + this.mod + "] AK-104 default win (you roll " + roll + " of " + this.vikConfig.sstc_twelve + ")");}
                }
                else if (roll <= this.vikConfig.sstc_seven)
                {
                    ...
                    count = 3;
                    newItemRequest.items.push(this.addToNewItemArray(id, isPreset, count));
					if (this.vikConfig.Logging){console.log("[" + this.mod + "] AKM default win (you roll " + roll + " of " + this.vikConfig.sstc_twelve + ")");}
                }
                else if (roll <= this.vikConfig.sstc_eight)
                {
                    ...
                    count = 3;
                    newItemRequest.items.push(this.addToNewItemArray(id, isPreset, count));
					if (this.vikConfig.Logging){console.log("[" + this.mod + "] AKMN default win (you roll " + roll + " of " + this.vikConfig.sstc_twelve + ")");}
                }
                else if (roll <= this.vikConfig.sstc_nine)
                {
                    ...
                    count = 3;
                    newItemRequest.items.push(this.addToNewItemArray(id, isPreset, count));
					if (this.vikConfig.Logging){console.log("[" + this.mod + "] AKMS default win (you roll " + roll + " of " + this.vikConfig.sstc_twelve + ")");}
                }
                else if (roll <= this.vikConfig.sstc_ten)
                {
                    ...
                    count = 3;
                    newItemRequest.items.push(this.addToNewItemArray(id, isPreset, count));
					if (this.vikConfig.Logging){console.log("[" + this.mod + "] AKMSN default win (you roll " + roll + " of " + this.vikConfig.sstc_twelve + ")");}
                }
                else if (roll <= this.vikConfig.sstc_eleven)
                {
                    ...
                    count = 3;
                    newItemRequest.items.push(this.addToNewItemArray(id, isPreset, count));
					if (this.vikConfig.Logging){console.log("[" + this.mod + "] VPO-136 Vepr-KM default win (you roll " + roll + " of " + this.vikConfig.sstc_twelve + ")");}
                }
                else
                {
                    ...
                    count = 3;
                    newItemRequest.items.push(this.addToNewItemArray(id, isPreset, count));
					if (this.vikConfig.Logging){console.log("[" + this.mod + "] AK103 Vik For 762 case win (you roll " + roll + " of " + this.vikConfig.sstc_twelve + ")");}
                }
            ...
            else if (whichGamblingContainer._name.includes("545"))
            {
                ...
                if (roll <= this.vikConfig.fff_one) 
                {
                    ...
                    count = 3;
                    newItemRequest.items.push(this.addToNewItemArray(id, isPreset, count));
					if (this.vikConfig.Logging){console.log("[" + this.mod + "] SAG-545 default win (you roll " + roll + " of " + this.vikConfig.fff_twelve + ")");}
                }
                else if (roll <= this.vikConfig.fff_two)
                {
                    ...
                    count = 3;
                    newItemRequest.items.push(this.addToNewItemArray(id, isPreset, count));
					if (this.vikConfig.Logging){console.log("[" + this.mod + "] SAG 545 Vik For 545 case win (you roll " + roll + " of " + this.vikConfig.fff_twelve + ")");}
                }
                else if (roll <= this.vikConfig.fff_three)
                {
                    ...
                    count = 3;
                    newItemRequest.items.push(this.addToNewItemArray(id, isPreset, count));
					if (this.vikConfig.Logging){console.log("[" + this.mod + "] AK-105 default win (you roll " + roll + " of " + this.vikConfig.fff_twelve + ")");}
                }
                else if (roll <= this.vikConfig.fff_four)
                {
                    ...
                    count = 3;
                    newItemRequest.items.push(this.addToNewItemArray(id, isPreset, count));
					if (this.vikConfig.Logging){console.log("[" + this.mod + "] AK 105 Vik For 545 case win (you roll " + roll + " of " + this.vikConfig.fff_twelve + ")");}
                }
                else if (roll <= this.vikConfig.fff_five)
                {
                    ...
                    count = 3;
                    newItemRequest.items.push(this.addToNewItemArray(id, isPreset, count));
					if (this.vikConfig.Logging){console.log("[" + this.mod + "] AK-74M win (you roll " + roll + " of " + this.vikConfig.fff_twelve + ")");}
                }
                else if (roll <= this.vikConfig.fff_six)
                {
                    ...
                    count = 3;
                    newItemRequest.items.push(this.addToNewItemArray(id, isPreset, count));
					if (this.vikConfig.Logging){console.log("[" + this.mod + "] AK 74m Vik For 545 case win (you roll " + roll + " of " + this.vikConfig.fff_twelve + ")");}
                }
                else if (roll <= this.vikConfig.fff_seven)
                {
                    ...
                    count = 3;
                    newItemRequest.items.push(this.addToNewItemArray(id, isPreset, count));
					if (this.vikConfig.Logging){console.log("[" + this.mod + "] AK-74N win (you roll " + roll + " of " + this.vikConfig.fff_twelve + ")");}
                }
                else if (roll <= this.vikConfig.fff_eight)
                {
                    ...
                    count = 3;
                    newItemRequest.items.push(this.addToNewItemArray(id, isPreset, count));
					if (this.vikConfig.Logging){console.log("[" + this.mod + "] AKS-74N win (you roll " + roll + " of " + this.vikConfig.fff_twelve + ")");}
                }
                else if (roll <= this.vikConfig.fff_nine)
                {
                    ...
                    count = 3;
                    newItemRequest.items.push(this.addToNewItemArray(id, isPreset, count));
					if (this.vikConfig.Logging){console.log("[" + this.mod + "] AKS-74U win (you roll " + roll + " of " + this.vikConfig.fff_twelve + ")");}
                }
                else if (roll <= this.vikConfig.fff_ten)
                {
                    ...
                    count = 3;
                    newItemRequest.items.push(this.addToNewItemArray(id, isPreset, count));
					if (this.vikConfig.Logging){console.log("[" + this.mod + "] AKS-74UB win (you roll " + roll + " of " + this.vikConfig.fff_twelve + ")");}
                }
                else if (roll <= this.vikConfig.fff_eleven)
                {
                    ...
                    count = 3;
                    newItemRequest.items.push(this.addToNewItemArray(id, isPreset, count));
					if (this.vikConfig.Logging){console.log("[" + this.mod + "] AKS-74UN win (you roll " + roll + " of " + this.vikConfig.fff_twelve + ")");}
                }
                else
                {
                    ...
                    count = 3;
                    newItemRequest.items.push(this.addToNewItemArray(id, isPreset, count));
					if (this.vikConfig.Logging){console.log("[" + this.mod + "] RPK-16 win (you roll " + roll + " of " + this.vikConfig.fff_twelve + ")");}
                }
            ...
            else if (whichGamblingContainer._name.includes("556"))
            {
                ...
                if (roll <= this.vikConfig.ffs_once)
                {
                    ...
                    count = 3;
                    newItemRequest.items.push(this.addToNewItemArray(id, isPreset, count));
					if (this.vikConfig.Logging){console.log("[" + this.mod + "] AK101 Vik For 556 case win (you roll " + roll + " of " + this.vikConfig.ffs_fourteen + ")");}
                }
                else if (roll <= this.vikConfig.ffs_tow)
                {
                    ...
                    count = 3;
                    newItemRequest.items.push(this.addToNewItemArray(id, isPreset, count));
					if (this.vikConfig.Logging){console.log("[" + this.mod + "] ADAR Vik For 556 case win (you roll " + roll + " of " + this.vikConfig.ffs_fourteen + ")");}
                }
                else if (roll <= this.vikConfig.ffs_three)
                {
                    ...
                    count = 3;
                    newItemRequest.items.push(this.addToNewItemArray(id, isPreset, count));
					if (this.vikConfig.Logging){console.log("[" + this.mod + "] M4a1 Vik For 556 case win (you roll " + roll + " of " + this.vikConfig.ffs_fourteen + ")");}
                }
                else if (roll <= this.vikConfig.ffs_four)
                {
                    ...
                    count = 3;
                    newItemRequest.items.push(this.addToNewItemArray(id, isPreset, count));
					if (this.vikConfig.Logging){console.log("[" + this.mod + "] MDR Vik For 556 case win (you roll " + roll + " of " + this.vikConfig.ffs_fourteen + ")");}
                }
                else if (roll <= this.vikConfig.ffs_five)
                {
                    ...
                    count = 3;
                    newItemRequest.items.push(this.addToNewItemArray(id, isPreset, count));
					if (this.vikConfig.Logging){console.log("[" + this.mod + "] AK-101 win (you roll " + roll + " of " + this.vikConfig.ffs_fourteen + ")");}
                }
                else if (roll <= this.vikConfig.ffs_six)
                {
                    ...
                    count = 3;
                    newItemRequest.items.push(this.addToNewItemArray(id, isPreset, count));
					if (this.vikConfig.Logging){console.log("[" + this.mod + "] AK-102 win (you roll " + roll + " of " + this.vikConfig.ffs_fourteen + ")");}
                }
                else if (roll <= this.vikConfig.ffs_seven)
                {
                    ...
                    count = 3;
                    newItemRequest.items.push(this.addToNewItemArray(id, isPreset, count));
					if (this.vikConfig.Logging){console.log("[" + this.mod + "] AUG A3 win (you roll " + roll + " of " + this.vikConfig.ffs_fourteen + ")");}
                }
                else if (roll <= this.vikConfig.ffs_eight)
                {
                    ...
                    count = 3;
                    newItemRequest.items.push(this.addToNewItemArray(id, isPreset, count));
					if (this.vikConfig.Logging){console.log("[" + this.mod + "] MDR win (you roll " + roll + " of " + this.vikConfig.ffs_fourteen + ")");}
                }
                else if (roll <= this.vikConfig.ffs_nine)
                {
                    ...
                    count = 3;
                    newItemRequest.items.push(this.addToNewItemArray(id, isPreset, count));
					if (this.vikConfig.Logging){console.log("[" + this.mod + "] HK 416A5 win (you roll " + roll + " of " + this.vikConfig.ffs_fourteen + ")");}
                }
                else if (roll <= this.vikConfig.ffs_ten)
                {
                    ...
                    count = 3
                    newItemRequest.items.push(this.addToNewItemArray(id, isPreset, count));
					if (this.vikConfig.Logging){console.log("[" + this.mod + "] G36 win (you roll " + roll + " of " + this.vikConfig.ffs_fourteen + ")");}
                }
                else if (roll <= this.vikConfig.ffs_eleven)
                {
                    ...
                    count = 3;
                    newItemRequest.items.push(this.addToNewItemArray(id, isPreset, count));
					if (this.vikConfig.Logging){console.log("[" + this.mod + "] M4A1 win (you roll " + roll + " of " + this.vikConfig.ffs_fourteen + ")");}
                }
                else if (roll <= this.vikConfig.ffs_twelve)
                {
                    ...
                    count = 3;
                    newItemRequest.items.push(this.addToNewItemArray(id, isPreset, count));
					if (this.vikConfig.Logging){console.log("[" + this.mod + "] Mk 16 win (you roll " + roll + " of " + this.vikConfig.ffs_fourteen + ")");}
                }
                else if (roll <= this.vikConfig.ffs_thirteen)
                {
                    ...
                    count = 7;
                    newItemRequest.items.push(this.addToNewItemArray(id, isPreset, count));
					if (this.vikConfig.Logging){console.log("[" + this.mod + "] ADAR 2-15 win (you roll " + roll + " of " + this.vikConfig.ffs_fourteen + ")");}
                }
                else
                {
                    ...
                    count = 3;
                    newItemRequest.items.push(this.addToNewItemArray(id, isPreset, count));
					if (this.vikConfig.Logging){console.log("[" + this.mod + "] TX-15 DML win (you roll " + roll + " of " + this.vikConfig.ffs_fourteen + ")");}
                }
    ...
    private doBlacklist(container: DependencyContainer) : void 
    {
        const configServer = container.resolve<ConfigServer>("ConfigServer");

        const ragfairConfig = configServer.getConfig<IRagfairConfig>(ConfigTypes.RAGFAIR);

        ragfairConfig.dynamic.blacklist.custom.push(
            "wallet_roll", 
            "keycard_roll", 
            "viktoriyas_secret", 
            "armor_crate", 
    ...
    private addToNewItemArray(id : string, preset : boolean, count : number)
    {
        const item =
        {
            item_id: id,
