...
export class WeaponCreateHelper 
{
    public createExfilB(): Item[]
    {
        const exfilb: Item[] = [];
    ...
    public createExfilCoyote(): Item[]
    {
        const exfilcoyote: Item[] = [];
    ...
    public createAltynShielded(): Item[]
    {
        const altyns: Item[] = [];
    ...
    public createRd704_vik(): Item[]
    {
        const rd704_vik: Item[] = [];
    ...
    public CreateT5000(): Item[]
    {
        const t5000_vik: Item[] = [];
    ...
    public createAk74N(): Item[]
    {
        const ak74n_vik: Item[] = [];
    ...
    public createRsh12(): Item[]
    {
        const rsh12_vik: Item[] = [];
    ...
    public createak103(): Item[]
    {
        const ak103_vik: Item[] = [];
    ...
    public createAK101(): Item[]
    {
        const ak101_vik: Item[] = [];
