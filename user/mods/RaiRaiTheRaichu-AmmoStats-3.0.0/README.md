...
### NEW: SPT Realism mod support! Enable it in the config.json if you're using the SPT Realism mod!
...
If you create a language addition, please PM me on Discord (RaiRaiTheRaichu#1005) ​or on hub.sp-tarkov.com (much slower response time) with the information and the mod will be updated and you can be credited.


## ---INSTALL INFO---

How to install:
Copy this folder: `zRaiRaiTheRaichu-AmmoStats-3.0.0` into your user/mods/ folder.
...
Copyright 2022-2023 - RaiRaiTheRaichu
