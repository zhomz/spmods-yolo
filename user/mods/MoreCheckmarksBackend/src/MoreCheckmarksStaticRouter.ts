        ...
        staticRouterModService.registerStaticRouter(
            ...
            [
                ...
                },
                {
                    ...
                    action: (url, info, sessionID, output) => 
                    {
                        logger.info("MoreCheckmarks making production request");
						
						const productions: ILocaleBase = {};
						if(databaseServer && databaseServer.getTables() && databaseServer.getTables().hideout)
						{
							return JSON.stringify(databaseServer.getTables().hideout.production);
							logger.info("Got productions");
						}
						else
						{
							return JSON.stringify(locales);
