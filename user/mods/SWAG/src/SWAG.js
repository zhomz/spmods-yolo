        ...
        staticRouterModService.registerStaticRouter(`${modName}/client/raid/configuration`, [
            {
                ...
                action: (url, info, sessionID, output) => {
                    try {
                        ...
                        const bot_config = container.resolve("ConfigServer").getConfig(ConfigTypes_1.ConfigTypes.BOT);
                        const pmc_config = container.resolve("ConfigServer").getConfig(ConfigTypes_1.ConfigTypes.PMC);
                        ...
                        if (SWAG.raid_time.time_of_day === "day") {
                            ...
                            bot_config.maxBotCap.factory4_night = config_json_1.default.NightMaxBotCap.factory_night;
                            bot_config.maxBotCap.bigmap = config_json_1.default.NightMaxBotCap.customs;
                            bot_config.maxBotCap.interchange = config_json_1.default.NightMaxBotCap.interchange;
                            bot_config.maxBotCap.shoreline = config_json_1.default.NightMaxBotCap.shoreline;
                            ...
                            bot_config.maxBotCap.laboratory = config_json_1.default.NightMaxBotCap.laboratory;
                            bot_config.maxBotCap.lighthouse = config_json_1.default.NightMaxBotCap.lighthouse;
                            bot_config.maxBotCap.tarkovstreets = config_json_1.default.NightMaxBotCap.streets;
